...
With the introduction of app centric management functionality, admins have two methods to control the access and availability of the apps.
...
This functionality lets you specify which users and groups can use each app and you can control it on a per-app basis.
