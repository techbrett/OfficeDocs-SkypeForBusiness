...
Although you don't get Intelligent Speaker as a features on Teams Rooms on Android yet, it's important that if you have Teams Rooms on Android devices you still get other AI-based features like noise suppression. To see what features are available, see [Teams Rooms and panels feature comparison](teams-devices-feature-comparison.md?tabs=Commercial).
...
When you want to add Copilot to Teams, you need to turn it on, enable transcriptions, and meeting recordings for your end users. After you turn it on, users will see the Copilot icon and options but transcription for meetings will also need to be turned on as well.
...
- **DisabledUserOverride:** Speakers aren't identified in the transcription. If enabled, users can change this setting and choose to be identified in their Teams profile settings.
