...
Verification checks aren't supported on the following clients and platforms, allowing all participants to join meetings without completing a CAPTCHA challenge:
