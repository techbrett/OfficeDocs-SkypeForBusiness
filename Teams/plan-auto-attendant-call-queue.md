...
> [!IMPORTANT]
> Nesting Auto attendants and Call queues without a resource account is not currently supported for [Authorized users](aa-cq-authorized-users-plan.md) in Queues App. If an Auto attendant or Call queue is nested without a resource account, the authorized user will not be able to edit the auto attendant or call queue.
>
