...
2. Assign API permissions to the application.
   ...
   - Note that there is no need to configure any API permission for “Skype and Teams Tenant Admin API”. Configuring this permission might result in authentication failures. 
