...
2. Assign API permissions to the application.
   ...
   - Please note that there is no need to configure any API permission for “Skype and Teams Tenant Admin API”. Configuring this might result in authentication failures. 
